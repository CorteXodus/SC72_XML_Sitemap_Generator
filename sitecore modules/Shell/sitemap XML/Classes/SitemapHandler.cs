...
namespace Sitecore.Modules.SitemapXML
{
    public class SitemapHandler
    {
        ...
        {
            SitemapBuildManager sitemapBuildManager = new SitemapBuildManager();
        }

        /***************************************************************/
        public bool SubmitSitemap(object sender, EventArgs args)
        {
            SitemapSubmitManager sitemapSubmitManager = new SitemapSubmitManager();

            if (!sitemapSubmitManager.SubmitSitemapToSearchenginesByHttp())
                return false;
